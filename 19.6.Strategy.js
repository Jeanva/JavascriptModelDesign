...
var InputStrategy = function(){
    var strategy = {    
        ...
        number : function(value){// 是否是一个数字
            return /^[0-9]+(\.[0-9]+)?$/.test(value) ? console.log(value) :console.log('请输入数字');
        },
        phone : function(value){// 是否是本地电话
            return /^\d[3]\-\d{8}$|^\d{4}\-\d{7}$/.test(value) ? console.log(value) :console.log('请输入正确的电话好吗格式，如：010-12345678 ');
        }
    }
    return {
