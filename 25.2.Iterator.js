// Iterator 迭代器模式,在不暴露对象内部结构的同时，可以顺序地访问聚合对象内部的元素
// 迭代器
var Iterator = function(items,container){
    ...
    length = items.length,
    // 当前索引值，默认：0
    index = 0;console.log('index',index,'length',length);
    // 缓存原生数组splice方法
    var splice = [].splice;
    return {
        // 获取第一个元素
        ...
        dealItem :  function(num,fn){
            // 对元素执行回调函数，注：1 第三个参数开始为回调函数中的参数 2 通过this.get方法设置index 索引值
